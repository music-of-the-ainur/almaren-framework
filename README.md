...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "almaren-framework" % "0.2.2-2-4"
```
...
## Sponsor
[![Modak Analytics](/docs/images/modak_analytics.png)](http://www.modakanalytics.com)
