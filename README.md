...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "almaren-framework" % "0.9.12-3.4"
```
...
```
spark-shell --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.12-3.4"
```
For scala version(2.13):
```
spark-shell --packages "com.github.music-of-the-ainur:almaren-framework_2.13:0.9.12-3.4"
```
