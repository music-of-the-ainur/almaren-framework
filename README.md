...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "almaren-framework" % "0.9.12-3.3"
```

To run in spark-shell:
For scala version-2.12:
```
spark-shell --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.12-3.3"
```
For scala version-2.13:
```
spark-shell --packages "com.github.music-of-the-ainur:almaren-framework_2.13:0.9.12-3.3"
```
