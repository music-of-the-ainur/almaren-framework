...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "almaren-framework" % "0.6.0-2.4"
```

To run in spark-shell:

```
spark-shell --packages "com.github.music-of-the-ainur:almaren-framework_2.11:0.6.0-2.4"
```
