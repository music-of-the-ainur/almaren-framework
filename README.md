...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "almaren-framework" % "0.9.3-3.2"
```

To run in spark-shell:

```
spark-shell --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.3-3.2"
```
